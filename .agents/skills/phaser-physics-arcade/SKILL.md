...
**Related skills:** ../phaser-game-setup-and-config/SKILL.md, ../phaser-sprites-and-images/SKILL.md, ../phaser-tilemaps/SKILL.md, ../phaser-groups-and-containers/SKILL.md
