...
color.g;
color.b;
color.a; // 0-255 integers
color.redGL;
color.greenGL;
color.blueGL;
color.alphaGL; // 0-1 floats (WebGL)
...
color.h;
color.s;
color.v; // HSV representation (read-only, auto-updated)
```
...
const hsvResult = Phaser.Display.Color.Interpolate.HSVWithHSV(
  0,
  1,
  1,
  0.5,
