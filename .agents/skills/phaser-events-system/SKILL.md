...
**Related skills:** ../phaser-scenes/SKILL.md, ../phaser-input-keyboard-mouse-touch/SKILL.md
...
Emitter: `this.input` (scene-level) or individual GameObjects. Events exist at three levels: scene-level (`this.input`), scene-level with gameobject prefix, and directly on interactive GameObjects. See ../phaser-input-keyboard-mouse-touch/SKILL.md for full usage.
