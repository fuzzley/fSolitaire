...
**Related skills:** ../phaser-game-setup-and-config/SKILL.md, ../phaser-sprites-and-images/SKILL.md, ../phaser-physics-arcade/SKILL.md, ../phaser-tilemaps/SKILL.md
