---
name: phaser-text-and-bitmaptext
...
**Related skills:** ../phaser-loading-assets/SKILL.md, ../phaser-sprites-and-images/SKILL.md, ../phaser-game-object-components/SKILL.md
