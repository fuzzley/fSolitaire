...
**Related skills:** ../phaser-sprites-and-images/SKILL.md, ../phaser-loading-assets/SKILL.md
...
const well2 = new Phaser.GameObjects.Particles.GravityWell(
  500,
  200,
  3,
  100,
...
this.add.particles(400, 300, "explosion", {
  anim: "explode_anim",
  lifespan: 1000,
});
...
_E = emit-only, E+U = emit + update (supports start/end, onUpdate)_
