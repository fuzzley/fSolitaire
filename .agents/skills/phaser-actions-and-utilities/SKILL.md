---
name: phaser-actions-and-utilities
...
**Related skills:** ../phaser-groups-and-containers/SKILL.md, ../phaser-sprites-and-images/SKILL.md
...
Phaser.Actions.PlaceOnCircle(
  group.getChildren(),
  new Phaser.Geom.Circle(400, 300, 200),
);
```
